class NewsfeedsController < ApplicationController
  before_action :set_newsfeed, only: [:show, :edit, :update, :destroy] # I took out  :set_newsfeed, before only!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  def index
    ...
    @combined = (@prayer_requests + @bible_studies + @announcements).sort_by {|record| record.created_at}
  end
